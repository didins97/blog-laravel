...
@section('header')
    ...
    <div id="post-header" class="page-header">
        <div class="page-header-bg" style="background-image: url('{{ asset($data->gambar)}}'); background-position: 0px 17px; background-size: 100%"
        ...
        <div class="col-md-4">
            <div class="post post-sm">
                ...
                <div class="post-body">
                    ...
                    <h3 class="post-title title-sm"><a href="blog-post.html">Mel ut impetus suscipit tincidunt.
        ...
        <div class="col-md-4">
            <div class="post post-sm">
                ...
                <div class="post-body">
                    ...
                    <h3 class="post-title title-sm"><a href="blog-post.html">Ne bonorum praesent cum, labitur
